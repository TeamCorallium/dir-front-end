...
app.factory('RestService', ['$rootScope', '$http', '$q', '$cookies', '$httpParamSerializer', '$state', function($rootScope, $http, $q, $cookies, $httpParamSerializer, $state) {
    ...
    var tshirt = 'http://www.dirstuff.com/server/api/tshirts/';
    var users = 'http://www.dirstuff.com/server/api/users/';
    var profiles = 'http://www.dirstuff.com/server/api/profiles/';
    var login = 'http://www.dirstuff.com/server/api/api-auth/login/';
    var loginNext = 'http://www.dirstuff.com/server/api/api-auth/login/?next=/';
    var register = 'http://www.dirstuff.com/server/api/api-auth/register/';
    var snippets = 'http://www.dirstuff.com/server/api/snippets/';
    var socialnetwork = 'http://www.dirstuff.com/server/api/socialnetworks/';
    var imageDir = 'http://www.dirstuff.com/dir/images/';
    var imageDownload = 'http://www.dirstuff.com/server/api/qrcode';
    var updateWithOutImage = 'http://www.dirstuff.com/server/api/updateprofile';
    var messages = 'http://www.dirstuff.com/server/api/messages/';
    var sendMessages = 'http://www.dirstuff.com/server/api/send-message/';
    var updatePassword = 'http://www.dirstuff.com/server/api/api-auth/update/';
    var clapDir = 'http://www.dirstuff.com/server/api/clap-profile/';
    var linkStuff = 'http://www.dirstuff.com/server/api/link-stuff/';
    var stocks = 'http://www.dirstuff.com/server/api/stocks/';
    var deleteUser = 'http://www.dirstuff.com/server/api/delete-user/';
    var tracking = 'http://www.dirstuff.com/server/api/track/';
    var followDir = 'http://www.dirstuff.com/server/api/follow/';
    var followersDir = 'http://www.dirstuff.com/server/api/followers/';
    var unfollowDir = 'http://www.dirstuff.com/server/api/unfollow/';
