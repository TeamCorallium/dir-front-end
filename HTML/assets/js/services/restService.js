...
app.factory('RestService', ['$rootScope', '$http', '$q', '$cookies', '$httpParamSerializer', '$state', function($rootScope, $http, $q, $cookies, $httpParamSerializer, $state) {
    ...
    var tshirt = 'http://www.dirstuff.com/api/tshirts/';
    var users = 'http://www.dirstuff.com/api/users/';
    var profiles = 'http://www.dirstuff.com/api/profiles/';
    var login = 'http://www.dirstuff.com/api/api-auth/login/';
    var loginNext = 'http://www.dirstuff.com/api/api-auth/login/?next=/';
    var register = 'http://www.dirstuff.com/api/api-auth/register/';
    var snippets = 'http://www.dirstuff.com/api/snippets/';
    var socialnetwork = 'http://www.dirstuff.com/api/socialnetworks/';
    var imageDir = 'http://www.dirstuff.com/dir/images/';
    var imageDownload = 'http://www.dirstuff.com/api/qrcode';
    var updateWithOutImage = 'http://www.dirstuff.com/api/updateprofile';
    var messages = 'http://www.dirstuff.com/api/messages/';
    var sendMessages = 'http://www.dirstuff.com/api/send-message/';
    var updatePassword = 'http://www.dirstuff.com/api/api-auth/update/';
    var clapDir = 'http://www.dirstuff.com/api/clap-profile/';
    var linkStuff = 'http://www.dirstuff.com/api/link-stuff/';
    var stocks = 'http://www.dirstuff.com/api/stocks/';
    var deleteUser = 'http://www.dirstuff.com/api/delete-user/';
    var tracking = 'http://www.dirstuff.com/api/track/';
    var followDir = 'http://www.dirstuff.com/api/follow/';
    var followersDir = 'http://www.dirstuff.com/api/followers/';
    var unfollowDir = 'http://www.dirstuff.com/api/unfollow/';
    var notifications = 'http://www.dirstuff.com/api/notifications/';
    var notificationsUnreaded = 'http://www.dirstuff.com/api/notifications-unreaded/';
