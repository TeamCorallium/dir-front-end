...
app.controller('HomeCtrl',["$scope", "$state", "$rootScope",
    function ($scope, $state, $rootScope) {
        ...
        $scope.currentYearHandler = function() {
            $(".current-year").text((new Date).getFullYear());
        };

        // function for Header shrink size based on scroll
        $scope.shrinkHeaderHandler = function() {
        ...
        $scope.sideBarToggleHandler = function() {
        ...
        $scope.setParallaxHandler = function() {
        ...
        $scope.scrollTopHandler = function() {
        ...
        $scope.overlaySearchHandler = function() {
        ...
        $scope.sliderCaptionHandler = function() {
        ...
        $scope.toggleClassHandler = function() {
        ...
        $scope.fullHeightHandler = function() {
        ...
        $scope.videoDimensionHandler = function(video, h) {
        ...
        $scope.appearAnimationHandler = function() {
        ...
        $scope.windowScrollHandler = function() {
            $win.scroll(function() {
                setParallaxHandler();
        ...
        $scope.resizeHandler = function(func, threshold, execAsap) {
            $win.resize(function() {
                navbarHandler();
                fullHeightHandler();
                sliderCaptionHandler();
        ...
        $scope.animatedProgressbarHandler = function() {
        ...
        $scope.stellarHandler = function(func, threshold, execAsap) {
            if (!isMobile()) {
                $.stellar({
        ...
        $scope.magnificPopupHandler = function(func, threshold, execAsap) {
        ...
        $scope.animationNumberHandler = function() {
            var numberElement = $('.counter');
            numberElement.each(function() {
                console.dir(numberElement);
                console.log("number count" + numberElement.length);
        ...
        $scope.sliderCaptionHandler();
        $scope.windowScrollHandler();
        $scope.resizeHandler();
        $scope.shrinkHeaderHandler();
        $scope.currentYearHandler();
        $scope.navbarHandler();
        $scope.overlaySearchHandler();
        $scope.sideBarToggleHandler();
        $scope.stellarHandler();
        $scope.toggleClassHandler();
        $scope.animationNumberHandler();
        $scope.appearAnimationHandler();
        $scope.setParallaxHandler();
        $scope.fullHeightHandler();
        $scope.animatedProgressbarHandler();
        $scope.magnificPopupHandler();
        $scope.swiperHandler();
